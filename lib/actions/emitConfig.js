...
module.exports.getFieldOne = async function getFieldOne(configuration){
  return {
    one: '1',
    two: '2',
    three: '3',
...
module.exports.getFieldTwo = async function getFieldTwo(configuration){
  return {
    one: '1',
    two: '2',
    three: '3',
...
module.exports.getFieldThree = async function getFieldThree(configuration){
  return {
    one: '1',
    two: '2',
    three: '3',
